...
<body id="page-top">
  ...
  <section id="about">
  <img src="./img/covid.png" id="imgcovid"/>
    <div class="container">
      <div class="row">
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <ul>
    ...
    <img src="./img/covidpre.png" id="imgcovidpre"/>
  </section>
  
  <!-- Footer -->
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Covid19 2022 - by simrat singh</p>
    </div>
    <!-- /.container -->
  </footer>
